...
include_once("../models/connection.php");
    ...
    if(($limite) AND ($limite->num_rows != 0)){
        ...
        // irá para primeira página
        // echo "<a href='#' onclick='listar_video(1, $qnt_result_pg)'>Primeira</a> ";

        // página anterior
        // for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
        //     if($pag_ant >= 1){
        //         echo " <a href='#' onclick='listar_video($pag_ant, $qnt_result_pg)'>$pag_ant </a> ";
        //     }
        // }

        // Página em que estamos
        // echo " $pagina ";

        // Proxima página
        // for ($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++) {
        //     if($pag_dep <= $quantidade_pg){
        //         echo " <a href='#' onclick='listar_video($pag_dep, $qnt_result_pg)'>$pag_dep</a> ";
        //     }
        // }
        // irá para ultima página
        // echo " <a href='#' onclick='listar_video($quantidade_pg, $qnt_result_pg)'>Última</a>";
        }else{
            echo "<div  role='alert'>Nenhum video encontrado!</div>";
        }
